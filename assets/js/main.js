...
function swapLinks(event) {
  ...
  languageBtn.addEventListener('click', swapLinks);
...
languageDropdown.addEventListener("mouseover", () => {
...
languageDropdownContent.addEventListener("mouseover", () => {
  languageDropdownContent.style.display = "block";
});

languageDropdownContent.addEventListener("mouseout", () => {
  languageDropdownContent.style.display = "none";
});
